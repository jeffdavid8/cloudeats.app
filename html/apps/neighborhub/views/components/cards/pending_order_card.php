...
<div class="nh-card nh-order-card"
  ...
  <div class="nh-card-body">
    ...
    <div class="nh-order-details">
      <div class="nh-order-detail-item">
        ...
        <span class="nh-order-detail-value">$<?php echo number_format($order['subtotal_amount'], 2); ?></span>
      </div>
      <div class="nh-order-detail-item">
  ...
  <div class="nh-card-footer">
    <button type="button" class="nh-btn nh-btn-secondary" onclick="confirmOrder(<?php echo intval($order['id']); ?>)" style="flex: 1;">
      Confirm Order
    </button>
  </div>
