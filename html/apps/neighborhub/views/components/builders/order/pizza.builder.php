...
<form id="custom-builder-form" data-product-id="<?php echo intval($productId); ?>">
    <?php foreach ($steps as $step): ?>
        ...
        <div class="builder-step-section" style="margin-bottom: 24px;">
            <h6 style="font-weight: 600; font-size: 1.15rem; color: #c62828;">
            ...
            <?php foreach ($step['options'] as $idx => $opt): 
                ...
                if ($isWidget): 
                    $priceLabel = ($optPrice > 0) ? ' <span style="color: #b71c1c; font-weight: 500;">(+$' . number_format($optPrice, 2) . ' ea)</span>' : '';
            ?>
            ...
            <?php else: 
                ...
                if ($isIncluded) {
                    ...
                    $priceLabel = ' <span style="color: #b71c1c; font-weight: 500;">(+$' . number_format($optPrice, 2) . ')</span>';
                } elseif ($optPrice < 0) {
        ...
        <hr style="border: 0; border-top: 2px dashed #ffcdd2; margin: 20px 0;">
    <?php endforeach; ?>
</form>