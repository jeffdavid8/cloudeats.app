...
<div class="container" style="display: flex; flex-direction: column; align-items: center; justify-content: flex-start; min-height: 50vh; text-align: center; margin-top: 2rem;">
  ...
  <!-- HERO SECTION -->
  <header class="hero-section center-align">
    <div class="container">
      ...
      <p class="flow-text grey-text text-lighten-1" style="max-width: 750px; margin: 0 auto 30px auto;">
        NeighborHub gives your restaurant its own branded online ordering system. Keep 100% of your food revenue, own your customer relationships, and offer better prices.
      </p>
