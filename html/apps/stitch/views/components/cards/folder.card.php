...
$displayContext = '';
$isFolder = ($anchor->content_type === 'folder');
$cardIcon = $isFolder ? 'folder_special' : 'grain';
$cardColor = $isFolder ? 'amber darken-2' : 'purple';
...
<div class="stitch-wrapper card <?= $glowClass ?> <?= $anchor->content_type ?> <?= $isFolder ? 'is-folder' : '' ?>"
  style="margin-bottom: 1.5rem; border-left: 5px solid <?= $isFolder ? '#ffa000' : '#9c27b0' ?>;"
  ...
  <div class="card-content">
    ...
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
        <i class="material-icons left <?= $isFolder ? 'amber-text' : 'purple-text text-lighten-3' ?>"><?= $cardIcon ?></i>
