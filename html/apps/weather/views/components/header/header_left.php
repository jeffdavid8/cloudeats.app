<ul class="left">
   ...
   */ ?>
   <li>
      <a title="Copy link" class="copyUrlBtn" href="#!"><i class="fas fa-link"></i></a>
   </li>
   <? /* 
   <li>
      <a title="Share link" class="shareUrlBtn" href="#!"><i class="material-icons left">share</i></a>
   </li>
   */ ?>
   <?
...
(function($) 
{
  $('.header .shareUrlBtn').on('click', function(e)
  {
    ...
    var facet = decodeURIComponent(params.get('s'));
    $('#share_page_search_string').val(facet).trigger('change');
