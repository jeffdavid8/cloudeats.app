   ...
   <div class="modal-content">
        ...
        <div class="row">
            <div class="input-field">
                ...
                <input class="" data-default-filename="bibleBot-bookmarks-<?= date("m-d-Y") ?>-<?= time() ?>.json" placeholder="bibleBot-bookmarks-<?= date("m-d-Y") ?>-<?= time() ?>.json (Default)" id="bookmarks_title" type="text">
