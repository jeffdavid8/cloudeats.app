...
<ul class="right" data-component="header-right">
    ...
    <?php if ($isUserLoggedIn): ?>
        ...
        <li>
            <!-- Dropdown Trigger -->
            <a class="dropdown-trigger user-badge" title="Logged in (<?= htmlspecialchars($username) ?>)" href="#!" data-target="user-dropdown" style="color: inherit; display: flex; align-items: center; min-width: auto; margin: 4px 0 0; padding: 5px 0 0 10px;">
